...
// robot-vacuum pictogram (body, camera/lidar turret, cliff-sensor slot, cleaning-line
// marks) rather than the stock mdi:robot-vacuum glyph, which reads poorly at this
// widget's small on-screen size.
const VW_ICON_VB='0 0 222.978402 150.251297';
const VW_ICON_TRANSFORM='translate(-0.021598,150.251297) scale(0.100000,-0.100000)';
const VW_ICON_PATHS='<path d="M905 1493 c-404 -38 -778 -199 -871 -377 -16 -30 -26 -57 -24 -59 3 -2 29 -7 58 -9 l52 -5 19 43 c53 119 247 236 500 300 94 24 292 54 357 54 31 0 34 2 34 30 0 29 -2 30 -42 28 -24 -1 -61 -3 -83 -5z"/><path d="M1071 1486 c-22 -26 -2 -47 43 -44 66 5 62 57 -5 58 -15 0 -32 -6 -38 -14z"/><path d="M1198 1471 c4 -29 7 -31 46 -31 59 0 235 -27 330 -49 253 -60 454 -178 514 -301 l21 -45 56 3 c37 3 55 8 55 17 0 26 -77 126 -130 170 -159 131 -488 238 -801 261 l-96 7 5 -32z"/><path d="M850 1395 c-402 -55 -670 -213 -670 -395 0 -128 134 -244 374 -324 383 -128 920 -105 1253 53 157 75 243 171 243 271 0 181 -277 343 -677 395 -137 18 -391 18 -523 0z m403 -144 c76 -21 117 -53 149 -115 24 -48 18 -75 -26 -114 -61 -53 -136 -75 -261 -75 -117 0 -180 14 -242 56 -34 23 -63 65 -63 93 0 27 56 107 88 126 82 48 240 61 355 29z m-289 -484 c25 -41 -74 -66 -108 -28 -16 17 -16 20 0 35 22 23 93 18 108 -7z m201 6 c16 -16 16 -18 -5 -35 -33 -27 -93 -21 -105 10 -14 38 77 58 110 25z m205 2 c27 -33 -20 -65 -75 -51 -57 14 -37 66 25 66 21 0 43 -7 50 -15z"/><path d="M1041 1239 c-35 -5 -84 -18 -110 -31 -39 -20 -46 -27 -46 -53 0 -24 7 -34 40 -52 135 -74 425 -35 425 57 0 20 -47 51 -95 65 -69 18 -139 23 -214 14z"/><path d="M860 1094 c0 -31 20 -52 72 -75 47 -21 67 -24 183 -24 111 0 137 3 175 21 54 25 80 49 80 74 0 17 -6 15 -62 -13 -60 -31 -65 -32 -193 -32 -128 0 -133 1 -193 32 -48 24 -62 28 -62 17z"/><path d="M7 1013 c-4 -3 -7 -117 -7 -252 0 -289 2 -297 103 -395 332 -323 1204 -406 1758 -167 129 56 194 97 267 169 100 100 102 104 102 394 l0 247 -37 7 c-47 9 -87 -12 -91 -47 -4 -32 13 -46 64 -57 l39 -8 -75 -75 c-88 -88 -215 -158 -383 -214 -488 -159 -1180 -103 -1544 127 -56 35 -173 148 -173 166 0 4 14 9 31 10 17 1 40 7 50 13 26 13 24 54 -3 73 -22 16 -89 22 -101 9z m1186 -583 c26 -29 27 -35 27 -136 l0 -106 -34 -34 c-26 -26 -42 -34 -71 -34 -82 0 -105 39 -105 181 l0 101 35 35 c32 32 39 35 78 30 30 -4 50 -15 70 -37z"/><path d="M1077 402 c-13 -14 -17 -39 -17 -110 0 -98 11 -122 54 -122 44 0 56 28 56 128 0 83 -2 92 -22 106 -29 21 -51 20 -71 -2z"/><path d="M2018 236 c-16 -12 -14 -14 21 -24 51 -16 68 -15 75 3 11 30 -63 47 -96 21z"/><path d="M195 235 c-5 -2 -22 -6 -37 -9 -19 -4 -28 -13 -28 -26 0 -23 16 -25 90 -9 l52 11 -31 19 c-17 10 -32 19 -34 18 -1 0 -6 -2 -12 -4z"/><path d="M1913 182 c-17 -11 93 -93 113 -85 24 9 16 28 -25 61 -40 32 -65 39 -88 24z"/><path d="M256 145 c-47 -37 -58 -61 -31 -71 21 -8 130 86 113 97 -22 14 -33 10 -82 -26z"/><path d="M386 84 c-7 -68 -3 -84 19 -84 17 0 23 20 27 84 2 42 -1 50 -19 57 -19 7 -21 3 -27 -57z"/><path d="M1813 143 c-23 -9 -11 -111 14 -120 28 -11 35 12 23 71 -11 56 -14 59 -37 49z"/><path d="M501 89 c9 -13 22 -34 30 -46 17 -28 49 -31 49 -4 0 27 -30 59 -65 67 -29 7 -29 7 -14 -17z"/><path d="M1624 76 c-18 -14 -18 -15 -1 -21 9 -4 24 -2 32 5 33 28 5 42 -31 16z"/>';
function vwIconHtml(vw){
  if(vw.icon)return'<ha-icon data-vwi="'+escA(vw.id)+'" class="vw-icon" icon="'+escA(vw.icon)+'" style="--mdc-icon-size:56%;width:56%;height:56%;position:relative;z-index:2;color:#fff;pointer-events:none;"></ha-icon>';
  return'<svg data-vwi="'+escA(vw.id)+'" class="vw-icon" viewBox="'+VW_ICON_VB+'" style="width:56%;height:56%;position:relative;z-index:2;pointer-events:none;overflow:visible;"><g transform="'+VW_ICON_TRANSFORM+'" fill="#fff">'+VW_ICON_PATHS+'</g></svg>';
}
...
// Editor "Duplicate" buttons: find a free id starting from baseId+'_2' (the
// original suffix scheme), bumping the number until it doesn't collide with
// any existing id in `arr`. Duplicating the same item twice used to always
// produce baseId+'_2' both times — the second copy then silently never
// updated (_render() caches elements by id via querySelector, so only the
// first match is ever found).
function rocDupId(baseId,arr){
  let n=2,id=baseId+'_'+n;
...
// ---- Light glow (v6.6.0) ------------------------------------------------
// A light-spill layer painted over the photo with mix-blend-mode: the colour
// comes from the light's own rgb_color / colour temperature, the strength from
// its brightness. Deliberately gradient-only -- no filter: blur(). Stacking a
// filter on a blended layer is the compositing combination that caused the
// v6.5.1 vacuum-widget repaint bug on tablet WebViews; the soft edge is made
// with gradient stops instead, which composites cleanly everywhere.
const GLOW_STOPS={
  soft:[[0,0.85],[40,0.35],[72,0]],
  tight:[[0,1],[22,0.5],[55,0]],
  wide:[[0,0.6],[55,0.22],[100,0]]
};
const GLOW_DEFAULT_RGB=[255,180,110];
// Accepts #rgb / #rrggbb / rgb(...) / "r,g,b" / "2700K"; null = derive from the entity
function glowParseColor(v){
  ...
  m=t.match(/^(\d{3,5})\s*k$/i);
  if(m)return kelvinToRgb(parseInt(m[1],10));
  return null;
}
function glowRgb(g,st){
  const fixed=glowParseColor(g.color);
  if(fixed)return fixed;
  const a=st&&st.attributes;
  if(a){
    if(Array.isArray(a.rgb_color)&&a.rgb_color.length>=3)return a.rgb_color;
    if(a.color_temp_kelvin)return kelvinToRgb(a.color_temp_kelvin);
    if(a.color_temp)return kelvinToRgb(Math.round(1e6/a.color_temp));
  }
  return glowParseColor(g.fallback_color)||GLOW_DEFAULT_RGB;
}
function glowBg(g,rgb){
  const c=rgb[0]+','+rgb[1]+','+rgb[2];
  const stops=(GLOW_STOPS[g.falloff]||GLOW_STOPS.soft).map(function(p){
    return'rgba('+c+','+p[1]+') '+p[0]+'%';
  }).join(',');
  if(g.shape==='wash'){
    // Directional spill: an ellipse anchored on the edge the light comes FROM,
    // so it fades on every side. A plain linear-gradient would leave hard
    // vertical seams down the box -- light does not have straight edges.
    let a=g.angle==null?180:(typeof g.angle==='number'?g.angle:parseFloat(g.angle));
    if(isNaN(a))a=180;
    const rad=a*Math.PI/180;
    const x=Math.round(50-50*Math.sin(rad)),y=Math.round(50+50*Math.cos(rad));
...
const ROC_ELEMENT_KEYS=['overlays','zones','badges','elements','icons','labels','gauges','vacuum_widgets','glows','blinds','groups'];
...
const ROOM_KEYS=['base_image','base_camera','camera_refresh','base_image_conditions','weather_overlay','filter_conditions','brightness_model','overlays','zones','badges','elements','icons','labels','gauges','vacuum_widgets','glows','blinds','groups','tap_action','cards_above','cards_below','light_controls'];
// Vacuum status widget -- cross-room/global informational badge (NOT a
// controller; tap only navigates elsewhere). Classifies each configured
// vacuum's status-sensor string (device_class: enum) into
// rest/error/dry/wet/both/active, then aggregates across all configured
// vacuums into one compact icon. Values verified against the user's real
// `sensor.*_status` entities 2026-08-30 -- see project notes/CHANGELOG.
// An unrecognised future status string deliberately falls through to
// 'active', not 'rest': a false "something's happening" is a safer failure
// mode than silently hiding real activity behind "all clear".
const ROC_VAC_REST=new Set(['unknown','idle','charger_disconnected','charging','charging_complete','device_offline','locked','shutting_down','unavailable']);
const ROC_VAC_ERROR=new Set(['error','charging_problem']);
const ROC_VAC_DRY=new Set(['cleaning','segment_cleaning','zoned_cleaning','spot_cleaning']);
const ROC_VAC_WET=new Set(['segment_mopping','zoned_mopping','robot_status_mopping']);
const ROC_VAC_BOTH=new Set(['clean_mop_cleaning','clean_mop_mopping','segment_clean_mop_cleaning','segment_clean_mop_mopping','zoned_clean_mop_cleaning','zoned_clean_mop_mopping']);
function rocVacCat(stateStr){
  const v=String(stateStr==null?'':stateStr).trim().toLowerCase();
  if(!v||ROC_VAC_REST.has(v))return'rest';
  if(ROC_VAC_ERROR.has(v))return'error';
  if(ROC_VAC_BOTH.has(v))return'both';
  if(ROC_VAC_DRY.has(v))return'dry';
  if(ROC_VAC_WET.has(v))return'wet';
  return'active';
}
function rocVacAggregate(cats){
  let hasError=false,hasBoth=false,hasDry=false,hasWet=false,hasActive=false,count=0;
  for(const cat of cats){
    if(cat==='rest')continue;
    count++;
    if(cat==='error')hasError=true;
    else if(cat==='both')hasBoth=true;
    else if(cat==='dry')hasDry=true;
    else if(cat==='wet')hasWet=true;
    else hasActive=true;
  }
  let overall='rest';
  if(hasError)overall='error';
  else if(hasBoth||(hasDry&&hasWet))overall='both';
  else if(hasDry)overall='dry';
  else if(hasWet)overall='wet';
  else if(hasActive)overall='active';
...
class RoomOverlayCard extends HTMLElement{
  ...
  setConfig(cfg){
    ...
    // Warn once about duplicate ids within the same list, per room — _render()
    // caches DOM nodes by id via querySelector, so a second item with the same
  ...
  _render(){
    ...
    const vwHtml=(_isGhost||_isMini)?'':(c.vacuum_widgets||[]).map(vw0=>{
      ...
      const vwSz=resolveSize(vw.size||'44px',_cardW);
    ...
    const glowHtml=(c.glows||[]).map(g0=>{
      ...
      if(g.animation==='flicker')_fx+='animation:roc-gw-flicker '+(g.animation_speed||'3.1s')+' ease-in-out infinite;';
      else if(g.animation==='pulse')_fx+='animation:roc-gw-pulse '+(g.animation_speed||'4s')+' ease-in-out infinite;';
    ...
    this._glowEls={};this._glowFxEls={};
    for(const g of(c.glows||[])){
      const gel=this.shadowRoot.querySelector('[data-glow="'+escSel(g.id)+'"]');
      if(!gel)continue;
    ...
    for(const b of(c.badges||[])){
      ...
      if(bel&&(b.tap_action||b.hold_action||b.double_tap_action))
        this._addZoneListeners(bel,b.tap_action,b.hold_action,b.double_tap_action,b.hold_delay);
    }
    this._icoEls={};this._icoIconEls={};
    ...
    for(const vw of(c.vacuum_widgets||[])){
      const el=this.shadowRoot.querySelector('[data-vw="'+escSel(vw.id)+'"]');
      if(!el)continue;
      this._vwEls[vw.id]=el;
      this._vwBgEls[vw.id]=this.shadowRoot.querySelector('[data-vwbg="'+escSel(vw.id)+'"]');
      this._vwIconEls[vw.id]=this.shadowRoot.querySelector('[data-vwi="'+escSel(vw.id)+'"]');
      this._vwCountEls[vw.id]=this.shadowRoot.querySelector('[data-vwc="'+escSel(vw.id)+'"]');
      if(vw.tap_action||vw.hold_action||vw.double_tap_action)
        this._addZoneListeners(el,vw.tap_action,vw.hold_action,vw.double_tap_action,vw.hold_delay);
    }
    ...
    if(tm){
      ...
      if(saveBtn){
        ...
        saveBtn.addEventListener('click',function(e){
          ...
          function _showOverlay(reason){
            ...
            // window.YAML is essentially never present in HA — _yaml.s() already
            // prefers it when available and otherwise uses the card's own small
            // YAML dumper, so this always actually produces YAML, not JSON, to
            // match the "paste in YAML editor" instruction below.
            const txt=_yaml.s(cfg);
      ...
      const _nudgeFn=(e)=>{
        ...
        _nudgeTimer=setTimeout(()=>{
          const nc=rocClone(this._config);
          const arr=type==='zone'?this._roomArr(nc,'zones'):type==='icon'?this._roomArr(nc,'icons'):type==='label'?this._roomArr(nc,'labels'):type==='element'?this._roomArr(nc,'elements'):type==='gauge'?this._roomArr(nc,'gauges'):type==='vacuum_widget'?this._roomArr(nc,'vacuum_widgets'):type==='glow'?this._roomArr(nc,'glows'):null;
    ...
    this._hlHandler=function(e){
      ...
      const pre={zone:'[data-z="',icon:'[data-ico="',label:'[data-lbl="',gauge:'[data-gauge="',badge:'[data-b="',element:'[data-el="',overlay:'[data-ov="',vacuum_widget:'[data-vw="',glow:'[data-glow="'}[d.kind];
      if(!pre)return;
  ...
  _snapCandidates(){
    ...
    ['zones','icons','labels','gauges','vacuum_widgets','glows','blinds','elements'].forEach(function(k){
  ...
  _applyResizeStyles(){
    ...
    for(const vw of(c.vacuum_widgets||[])){
      const vel=this._vwEls[vw.id];if(!vel)continue;
  ...
  _update(){
    ...
    for(const g0 of(c.glows||[])){
      ...
      this._setGrpVis(gel,gShow);
      if(!gShow)continue;
      // `visible:` was documented (and in the editor's YAML box label) since
      // v6.8.0 but never actually evaluated here — only `visible_template`
      // worked, via _setupTemplates() setting display directly. Mirror the
      // icon loop above.
      const gShow2=g.visible_template!==undefined?(this._tmplVis['gw:'+g0.id]??true):(g.visible?evalCond(g.visible,s):true);
      this._setVis(gel,gShow2,'',g.fade,g.slide);
      const gst=g.entity?s[g.entity]:null;
      let gOn=!!gst&&gst.state!=='off'&&gst.state!=='unavailable'&&gst.state!=='unknown';
      if(flipped)gOn=!gOn;
      let gOp=0;
      if(gOn){
        const br=(gst&&gst.attributes)?gst.attributes.brightness:null;
        const frac=(br==null||flipped)?1:Math.max(0,Math.min(1,br/255));
        const minb=g.min_brightness??0;
        gOp=(br!=null&&!flipped&&br<minb)?0:(g.intensity==null?0.7:Number(g.intensity))*frac;
      }
      // Edit mode keeps every glow visible (and grabbable) even with its light off
      if((c.test_mode??false)&&gOp<0.25)gOp=0.25;
      setSt(gel,'opacity',Math.max(0,Math.min(1,gOp)).toFixed(3));
      const gfx=this._glowFxEls[g0.id];
      if(gfx&&gOp>0){
        const gbg=glowBg(g,glowRgb(g,gst));
        if(gfx.dataset.gwBg!==gbg){gfx.dataset.gwBg=gbg;gfx.style.backgroundImage=gbg;}
      }
    }
    // Weather overlay
    ...
    for(const vw of(c.vacuum_widgets||[])){
      const el=this._vwEls[vw.id];if(!el)continue;
      const gShow=!vw.group||(this._groupState[vw.group]??true);
      this._setGrpVis(el,gShow);
      if(!gShow)continue;
      const vShow=vw.visible?evalCond(vw.visible,s):true;
      this._setVis(el,vShow,'flex',vw.fade,vw.slide);
      if(!vShow)continue;
      if(this._needsCardWidth){
        const vsz=resolveSize(tApply(vw,this._tier).size||vw.size||'44px',_icoW);
        if(vsz&&el.style.width!==vsz){el.style.width=vsz;el.style.height=vsz;}
      }
      const cats=(vw.vacuums||[]).map(vv=>rocVacCat(s[vv.entity]?.state));
      const vwAgg=rocVacAggregate(cats);
      if(el.dataset.vwCat!==vwAgg.overall){
        el.classList.remove('vw-rest','vw-dry','vw-wet','vw-both','vw-active','vw-error');
        el.classList.add('vw-'+vwAgg.overall);
        el.dataset.vwCat=vwAgg.overall;
      }
      const cEl=this._vwCountEls[vw.id];
      if(cEl){
        const show=vwAgg.count>=2;
        const dv=show?'inline-flex':'none';
        if(cEl.style.display!==dv)cEl.style.display=dv;
        if(show&&cEl.textContent!==String(vwAgg.count))cEl.textContent=String(vwAgg.count);
      }
    }
  ...
  disconnectedCallback(){
    // Kept (not nulled) — revived on reconnect, same as _hlHandler/_orientHandler
    // below. Nulling here was the bug: HA's edit-mode toggle disconnects and
    // reconnects the element without a full re-render in between, and
    // connectedCallback never recreated these, so Escape / arrow-nudge died
    // the first time the card was moved while a panel was open or an element
    // was selected in Edit mode.
    if(this._tmKeyHandler)document.removeEventListener('keydown',this._tmKeyHandler);
    if(this._secKeyHandler)document.removeEventListener('keydown',this._secKeyHandler);
  ...
  connectedCallback(){
    ...
    if(this._rendered&&this._config){
      ...
      if(this._tmKeyHandler)document.addEventListener('keydown',this._tmKeyHandler);
      if(this._secKeyHandler)document.addEventListener('keydown',this._secKeyHandler);
...
class RoomOverlayCardEditor extends HTMLElement{
  ...
  setConfig(cfg){
    ...
    if(prev&&this.innerHTML.trim()){
      ...
      const same=
        ...
        (pR.glows||[]).length===(cR.glows||[]).length&&
  ...
  _collectConfig(){
    ...
    tgt.badges=(tgt.badges||[]).map(function(b,i){
      ...
      // nav_mini has its own dedicated checkbox (like every other item type) —
      // it must be applied AFTER the YAML merge so it wins, not before (it
      // used to run before the merge, so unchecking "Hide from mini" did
      // nothing until the YAML box was also touched).
    ...
    tgt.icons=(tgt.icons||[]).map(function(ico,i){
      ...
      const chipEl=q('[data-ico-chip="'+i+'"]');if(chipEl){if(chipEl.checked)o.chip=true;else delete o.chip;}
    ...
    tgt.glows=(tgt.glows||[]).map(function(g,i){
      const o=Object.assign({},g);
      const idEl=q('[data-gw-id="'+i+'"]');if(idEl)o.id=idEl.value;
      const entEl=q('[data-gw-ent="'+i+'"]');if(entEl){if(entEl.value.trim())o.entity=entEl.value.trim();else delete o.entity;}
      const shEl=q('[data-gw-shape="'+i+'"]');if(shEl){if(shEl.value&&shEl.value!=='circle')o.shape=shEl.value;else delete o.shape;}
      const szEl=q('[data-gw-size="'+i+'"]');if(szEl){const _v=szEl.value.trim();if(_v)o.size=_v;else delete o.size;}
      const wEl=q('[data-gw-w="'+i+'"]');if(wEl){const _v=wEl.value.trim();if(_v)o.width=_v;else delete o.width;}
      const hEl=q('[data-gw-h="'+i+'"]');if(hEl){const _v=hEl.value.trim();if(_v)o.height=_v;else delete o.height;}
      const tEl=q('[data-gw-top="'+i+'"]');if(tEl)o.top=tEl.value;
      const lEl=q('[data-gw-left="'+i+'"]');if(lEl)o.left=lEl.value;
      const inEl=q('[data-gw-int="'+i+'"]');if(inEl&&inEl.value!==''){const _n=parseFloat(inEl.value);if(!isNaN(_n))o.intensity=_n;}
      const foEl=q('[data-gw-fall="'+i+'"]');if(foEl){if(foEl.value&&foEl.value!=='soft')o.falloff=foEl.value;else delete o.falloff;}
      const blEl=q('[data-gw-blend="'+i+'"]');if(blEl){if(blEl.value&&blEl.value!=='screen')o.blend=blEl.value;else delete o.blend;}
      const coEl=q('[data-gw-color="'+i+'"]');if(coEl){const _v=coEl.value.trim();if(_v&&_v!=='auto')o.color=_v;else delete o.color;}
    ...
    ['overlays','zones','badges','elements','icons','labels','gauges','vacuum_widgets','glows','blinds','groups','filter_conditions'].forEach(function(k){
  ...
  _badgeItem(b,i){
    const bCopy=Object.assign({},b);delete bCopy.id;delete bCopy.icon;delete bCopy.position;delete bCopy.x;delete bCopy.y;delete bCopy.animation;delete bCopy.animation_color;delete bCopy.nav_mini;
  ...
  _icoItem(ico,i){
    ...
    h+='<div style="display:flex;align-items:center;gap:7px;padding-top:18px;"><input data-ico-chip="'+i+'" type="checkbox"'+(ico.chip?' checked':'')+' style="width:16px;height:16px;cursor:pointer;"><label style="font-size:12px;cursor:pointer;">Chip style (frosted-glass circle, v6.12.1)</label></div>';
  ...
  _glowItem(g,i){
    ...
    const prevBg=glowBg(g,sw||GLOW_DEFAULT_RGB);
    ...
    h+='</select></div>';
    h+='<div><label class="roc-l">Size (px or % of width)</label><input data-gw-size="'+i+'" type="text" placeholder="25%" value="'+this._e(g.size||'')+'"'+this._inp('')+'></div>';
    h+='</div>';
    h+='<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-bottom:8px;">';
    h+='<div><label class="roc-l">Width (ellipse / wash)</label><input data-gw-w="'+i+'" type="text" placeholder="= size" value="'+this._e(g.width||'')+'"'+this._inp('')+'></div>';
    h+='<div><label class="roc-l">Height (ellipse / wash)</label><input data-gw-h="'+i+'" type="text" placeholder="= width" value="'+this._e(g.height||'')+'"'+this._inp('')+'></div>';
    h+='<div><label class="roc-l">Top (centre)</label><input data-gw-top="'+i+'" type="text" value="'+this._e(g.top||'')+'"'+this._inp('')+'></div>';
    ...
    h+='</select></div>';
    h+='<div><label class="roc-l">Blend</label><select data-gw-blend="'+i+'"'+this._inp('')+'>';
    ...
    [['','none'],['flicker','flicker — candle / fireplace'],['pulse','pulse — slow breathing']]
      .forEach(function(o){h+='<option value="'+o[0]+'"'+((g.animation||'')===o[0]?' selected':'')+'>'+o[1]+'</option>';});
    h+='</select></div>';
    h+='<div><label class="roc-l">Angle (wash only)</label><input data-gw-angle="'+i+'" type="text" placeholder="180deg = downward" value="'+this._e(g.angle==null?'':String(g.angle))+'"'+this._inp('')+'></div>';
  ...
  _vwItem(vw,i){
    ...
    h+='<div><label class="roc-l">Icon override (mdi:... — optional)</label><div style="display:flex;gap:6px;align-items:center;">'+(vw.icon?'<ha-icon data-roc-prev icon="'+this._e(vw.icon)+'" style="--mdc-icon-size:20px;flex:none;color:var(--primary-text-color);"></ha-icon>':'')+'<input data-vw-icon="'+i+'" type="text" placeholder="leave blank for the built-in vacuum icon" value="'+this._e(vw.icon||'')+'"'+this._inp('')+'></div></div>';
  ...
  _render(){
    ...
    let gwInner='<div id="gw-list">';
    (cR.glows||[]).forEach(function(g,i){gwInner+=self._glowItem(g,i);});
    gwInner+='</div><button id="add-gw" style="'+btnStyle+'margin-top:4px;">+ Add light glow</button>';
    ...
    if(hasRooms){
      ...
      [['top','top'],['bottom','bottom'],['left','left (side rail)'],['right','right (side rail)']].forEach(function(o){riNav+='<option value="'+o[0]+'"'+((_nav.position||'top')===o[0]?' selected':'')+'>'+o[1]+'</option>';});
      riNav+='</select></div>';
      riNav+='</div>';
    ...
    const _onboardHtml=
      ...
      +'<div style="font-size:12px;color:var(--secondary-text-color);margin:0 auto 14px;max-width:430px;line-height:1.5;">Start with a background — a floor-plan or room photo. Then turn on <b>Edit mode</b> above and drag elements onto it. The rest of the editor appears once a background is set.</div>'
    ...
    let respInner='<p style="font-size:12px;color:var(--secondary-text-color);margin:0 0 10px;line-height:1.5;">Two layout profiles — <b>portrait</b> / <b>landscape</b> — picked by the viewport&#39;s width/height ratio (not by device type). Each profile is a % grid of the available screen and every block (region) gets a cell. <b>You own the percentages</b> (rows should sum to &le;100). Turn on <b>Edit mode</b> to see region outlines and a profile switch button on the card.</p>';
    ...
    const _tabbedHtml=
      ...
      +_panel('elements',
         ...
         +sec('glows','Light glow — light spill on the photo',(cR.glows||[]).length,gwInner,'mdi:lightbulb-on-outline')
  ...
  _scanUntagged(c){
    ...
    // rocTileDef() resolves the entity the same way the card itself does —
    // reading t.item.entity directly missed declared tiles (item:{id,tile},
    // no top-level entity), so an entity used only in a declared tile was
    // still offered by the "Find untagged devices" scan as if unused.
    collected.forEach(function(sx){sx.tiles.forEach(function(t){const e=rocTileDef(t).entity;if(e)collectedEntities.add(e);});});
  ...
  _listen(){
    ...
    const _hlKinds={ov:['overlays','overlay'],z:['zones','zone'],b:['badges','badge'],el:['elements','element'],ico:['icons','icon'],lbl:['labels','label'],g:['gauges','gauge'],bl:['blinds','gauge'],vw:['vacuum_widgets','vacuum_widget'],gw:['glows','glow']};
    this.querySelectorAll('details[data-panel]').forEach(function(d){
      d.addEventListener('toggle',function(){
        if(!d.open)return;
        const m=d.dataset.panel.match(/^(ov|z|b|el|ico|lbl|g|bl|vw|gw)-(\d+)$/);
        if(!m)return;
    ...
    // Light glow
    const addGw=this.querySelector('#add-gw');
    if(addGw)addGw.addEventListener('click',function(){
      const c=self._collectConfig();
      const gA=A(c,'glows');
      gA.push({id:'glow_'+(gA.length+1),entity:'',top:'40%',left:'50%',size:'25%',intensity:0.7});
      self._config=c;self._render();self._fire(c);
    });
    this.querySelectorAll('[data-rm-gw]').forEach(function(btn){
      btn.addEventListener('click',function(){
        const i=parseInt(btn.dataset.rmGw);
        const c=self._collectConfig();
        A(c,'glows').splice(i,1);
        self._config=c;self._render();self._fire(c);
      });
    });
    this.querySelectorAll('[data-dup-gw]').forEach(function(btn){
      btn.addEventListener('click',function(){
        const i=parseInt(btn.dataset.dupGw),c=self._collectConfig();
        const dA=A(c,'glows');if(!dA[i])return;
        const cl=rocClone(dA[i]);cl.id=rocDupId(cl.id,dA);cl.top=_cp(cl.top);cl.left=_cp(cl.left);
    ...
    this.querySelectorAll('[data-dup-ico]').forEach(function(btn){btn.addEventListener('click',function(){const i=parseInt(btn.dataset.dupIco),c=self._collectConfig();const dA=A(c,'icons');if(!dA[i])return;const cl=rocClone(dA[i]);cl.id=rocDupId(cl.id,dA);cl.top=_cp(cl.top);cl.left=_cp(cl.left);dA.splice(i+1,0,cl);self._config=c;self._render();self._fire(c);});});
    this.querySelectorAll('[data-dup-lbl]').forEach(function(btn){btn.addEventListener('click',function(){const i=parseInt(btn.dataset.dupLbl),c=self._collectConfig();const dA=A(c,'labels');if(!dA[i])return;const cl=rocClone(dA[i]);cl.id=rocDupId(cl.id,dA);cl.top=_cp(cl.top);cl.left=_cp(cl.left);dA.splice(i+1,0,cl);self._config=c;self._render();self._fire(c);});});
    this.querySelectorAll('[data-dup-g]').forEach(function(btn){btn.addEventListener('click',function(){const i=parseInt(btn.dataset.dupG),c=self._collectConfig();const dA=A(c,'gauges');if(!dA[i])return;const cl=rocClone(dA[i]);cl.id=rocDupId(cl.id,dA);cl.top=_cp(cl.top);cl.left=_cp(cl.left);dA.splice(i+1,0,cl);self._config=c;self._render();self._fire(c);});});
    this.querySelectorAll('[data-dup-bl]').forEach(function(btn){btn.addEventListener('click',function(){const i=parseInt(btn.dataset.dupBl),c=self._collectConfig();const dA=A(c,'blinds');if(!dA[i])return;const cl=rocClone(dA[i]);cl.id=rocDupId(cl.id,dA);cl.top=_cp(cl.top);cl.left=_cp(cl.left);dA.splice(i+1,0,cl);self._config=c;self._render();self._fire(c);});});
    ...
    this.querySelectorAll('[data-dup-z]').forEach(function(btn){btn.addEventListener('click',function(){const i=parseInt(btn.dataset.dupZ),c=self._collectConfig();const dA=A(c,'zones');if(!dA[i])return;const cl=rocClone(dA[i]);cl.id=rocDupId(cl.id,dA);cl.top=_cp(cl.top);cl.left=_cp(cl.left);dA.splice(i+1,0,cl);self._config=c;self._render();self._fire(c);});});
    ...
    this.querySelectorAll('[data-b-nav-mini],[data-el-nav-mini],[data-ico-nav-mini],[data-lbl-nav-mini],[data-g-nav-mini],[data-bl-nav-mini],[data-ico-chip]').forEach(function(el){el.addEventListener('change',fire);});
